...
namespace Magazines\Magazines\Code\Tables;
 ...
 * Magazines
 *
 * @ORM\Table(name="magazines_magazines", indexes={@ORM\Index(name="category_id_index", columns={"category_id"})})
 * @ORM\Entity
 * @ORM\HasLifecycleCallbacks
 */
class Magazines extends \Kazist\Table\BaseTable
{
    /**
     * @var integer
     *
